...
def prepare(
    destination_path: Path = Path("/workspace/data"),
    checkpoint_dir: Path = Path("/workspace/checkpoints/EleutherAI/pythia-410m-deduped"),
    seed: int = 7554,
    ...
    dataset = load_dataset("/workspace/vi_corpus", num_proc=num_proc_load_dataset)
